...
Route::middleware('auth')->group(function () {
    ...
    // Customer Management Routes (Kasir, Admin Toko, Tenant Owner)
    Route::middleware('role:Kasir|Admin Toko|Tenant Owner')->prefix('customers')->name('customers.')->group(function () {
        Route::get('/', [CustomerController::class, 'index'])->name('index');
        Route::get('/create', [CustomerController::class, 'create'])->name('create');
        Route::post('/', [CustomerController::class, 'store'])->name('store');
        Route::get('/search-by-phone', [CustomerController::class, 'searchByPhone'])->name('searchByPhone');
